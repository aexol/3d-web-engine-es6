...
*/
export class Shader extends MObject {
    constructor(vertexSource, fragmentSource, noBuild) {
        super()
        this.cp = -1.0;
        this.uniformsSet = {}
        this.construct = {
    ...
    _checkUniforms(value, location, name, lname) {
...
Shader.fromFile = (vertexUrl, fragmentUrl, callback) => {
	var shader
	loadFiles([vertexUrl, fragmentUrl], shaderText => {
