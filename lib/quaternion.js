...
/**
  ...
  * @constructor
*/
var Quaternion = exports.Quaternion = function () {
    function Quaternion(x, y, z, w, epsilon) {
    ...
    */
    ...
    _createClass(Quaternion, [{
        ...
        value: function getMatrix() {
            ...
            var rotMatrix = new _matrix.Matrix();
            rotMatrix.m[15] = 1.0;
        ...
        */
        ...
        value: function multiply(q) {
            ...
            return new Quaternion(b ? q.w * this.x + q.x * this.w - q.y * this.z + q.z * this.y : this.x * q, b ? q.w * this.y + q.y * this.w - q.z * this.x + q.x * this.z : this.y * q, b ? q.w * this.z + q.z * this.w - q.x * this.y + q.y * this.x : this.z * q, b ? q.w * this.w - q.x * this.w - q.y * this.y - q.z * this.z : this.w * q);
        }
        ...
        */
        ...
        key: 'divide',
        value: function divide(q) {
            var b = q instanceof Quaternion;
            return new Quaternion(b ? q.w * this.x + q.x * this.w - q.y * this.z + q.z * this.y : q, b ? q.w * this.y + q.y * this.w - q.z * this.x + q.x * this.z : q, b ? q.w * this.z + q.z * this.w - q.x * this.y + q.y * this.x : q, b ? q.w * this.w - q.x * this.w - q.y * this.y - q.z * this.z : q);
        }
        ...
        */
        ...
        key: 'getQuaternionFromEulerAnglesRad',
        value: function getQuaternionFromEulerAnglesRad(x, y, z) {
        ...
        */
        ...
        key: 'getQuaternionFromEulerDeg',
        value: function getQuaternionFromEulerDeg(x, y, z) {
        ...
        */
        ...
        key: 'getQuaternionFromAxisAngle',
        value: function getQuaternionFromAxisAngle(v, fi) {
        ...
        */
        ...
        key: 'getQuaternionFromAxisAngleDeg',
        value: function getQuaternionFromAxisAngleDeg(v, fi) {
        ...
        */
        ...
        key: 'getQuaternionFromMatrix',
        value: function getQuaternionFromMatrix(m) {
            var qw, qx, qy, qz;
            var matrix = m.m;
        ...
        */
        ...
        key: 'getQuaternionFromSpherical',
        value: function getQuaternionFromSpherical(latitude, longitude, angle) {
        ...
        */
        ...
        key: 'getRotationTo',
        value: function getRotationTo(fromV, toV) {
